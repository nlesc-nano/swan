...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_swan``)
...
* For convenience, the package version is stored in a single place: ``swan/__version__.py``. For updating the version number, you only have to change this file.
...
.. code-block:: console
  ...
  git clone https://github.com/nlesc-nano/swan.git
  cd swan
  pip install .
...
If you want to contribute to the development of Screening Workflows And Nanomaterials,
